...
import { UpdateFeaturesDto, ToggleFeatureDto } from '../dto/feature-management.dto'
...
export class AdminFeaturesService {
  ...
  async toggleFeature(
    ...
    await this.auditLog.log({
      action: data.enabled ? AuditAction.FEATURE_ENABLED : AuditAction.FEATURE_DISABLED,
      performedBy: updatedBy,
      targetType: 'feature',
  ...
  async getAvailableFeatures() {
    ...
    return {
      ...
      'builder.access': { name: 'Builder Access', description: 'Access visual builder' },
      'builder.blocks': { name: 'Custom Blocks', description: 'Use custom blocks' },
      'builder.layout': { name: 'Layout Control', description: 'Control page layouts' },
      'config.header': { name: 'Header Config', description: 'Configure site header' },
      'config.footer': { name: 'Footer Config', description: 'Configure site footer' },
      'config.menus': { name: 'Menu Config', description: 'Configure navigation menus' },
      'config.logos': { name: 'Logo Config', description: 'Configure site logos' },
      'assets.upload': { name: 'Upload Assets', description: 'Upload media files' },
      'assets.delete': { name: 'Delete Assets', description: 'Delete media files' },
      'users.invite': { name: 'Invite Users', description: 'Invite new users' },
      'users.manage': { name: 'Manage Users', description: 'Manage user accounts' },
      'posts.create': { name: 'Create Posts', description: 'Create blog posts' },
      'posts.edit': { name: 'Edit Posts', description: 'Edit blog posts' },
      'posts.delete': { name: 'Delete Posts', description: 'Delete blog posts' },
    }
  }
}
