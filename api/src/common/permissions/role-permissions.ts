...
export const ROLE_PERMISSIONS: Record<TenantRole, Permission[]> = {
  ...
  [TenantRole.AGENCY_ADMIN]: [
    ...
    // Site Builder — full
    Permission.HEADERS_VIEW,
    Permission.HEADERS_CREATE,
    Permission.HEADERS_EDIT,
    Permission.HEADERS_DELETE,
    Permission.FOOTERS_VIEW,
    Permission.FOOTERS_CREATE,
    Permission.FOOTERS_EDIT,
    Permission.FOOTERS_DELETE,
    Permission.MENUS_VIEW,
    Permission.MENUS_CREATE,
    Permission.MENUS_EDIT,
    Permission.MENUS_DELETE,
    Permission.LIBRARY_VIEW,
    Permission.LIBRARY_CREATE,
    Permission.LIBRARY_EDIT,
