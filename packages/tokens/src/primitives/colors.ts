/**
 * Tailwind CSS Color Primitives
 *
 * Complete color palette from Tailwind CSS v3.4
...
export type GrayScaleName = "slate" | "gray" | "zinc" | "neutral" | "stone";
...
/** Get a specific color shade, e.g., getColor("blue", "500") */
export function getColor(
  name: Exclude<ColorName, "white" | "black" | "transparent" | "current">,
  shade: ColorShade,
): string {
