 ...
 * Shared between builder (font picker) and client (font loading).
 */

// Re-export font types from design-system
export type {
  FontDefinition,
  FontRole,
  FontRoles,
...
type FontCategory = GoogleFont["category"];
...
/**
 * Generate Google Fonts preconnect links for performance
 */
