 ...
 *
 * A plain config object so it can be swapped per site and, later, sourced from
 * the CMS without touching the consent logic. Different clients have different
 * legal needs (GDPR/CCPA, wording) — change it here.
 */
