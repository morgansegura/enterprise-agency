      ...
      <main>
        ...
        <MediaSplit
          ...
          body={
            <>
              <p>
                Foundations players come to us as four-year-olds and leave at
                nine ready for competitive tryouts. The job in those years
                isn&rsquo;t winning — it&rsquo;s ball mastery, dribbling,
                shooting, and 1v1 attacking and defending. Build the skills
                first, and confidence follows.
              </p>
              <p>
                Our Foundations program is COED, runs Monday through Wednesday
                with matches on Saturdays, and rotates new technical content
                every week. New families are welcome year-round.
              </p>
            </>
          }
          image={{
            ...
            description={
              <>
                <p>
                  ...
                  <strong>Girls</strong> (DPL, NPL, GA Aspire, SoCal Flight), or
                  the <strong>Goalkeeper</strong> pathway. Every competitive
                  pathway leads to college recruiting visibility, and a few
                  alumni go on to sign professional contracts with MLS clubs and
                  Liga MX academies.
                </p>
                <p>
                  Most of our Foundations players won&rsquo;t turn pro. That was
                  never the point. They&rsquo;ll learn how to compete, how to
                  lose and come back, how to lead a teammate, and how to keep
                  showing up — skills that matter long after the last whistle
                  blows.
                </p>
              </>
            }
        ...
        <Callout
          ...
          body={
            <>
              ...
              player&rsquo;s pathway and birth year, and a CVFC coach will be in
