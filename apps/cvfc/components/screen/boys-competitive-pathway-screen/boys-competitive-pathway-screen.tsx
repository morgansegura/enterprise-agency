...
export async function BoysCompetitivePathwayScreen() {
          ...
          <>
            ...
            <MediaSplit
              ...
              body={
                <>
                  <p>
                    Chula Vista FC is a proud member of the MLS NEXT League,
                    where our top-flight boys&rsquo; teams are provided with a
                    purpose-driven path to professional play and college
                    athletics. MLS NEXT clubs combined have produced more than
                    90 percent of the U.S. Youth National Team players in 2019 —
                    establishing it as the top destination for the best young
                    players in North America.
                  </p>
                  <p>
                    Players are scouted through the MLS NEXT Showcases held
                    throughout the season and challenged by the best teams in
                    the country. Coaches commit to a high-intensity regimen that
                    focuses on player identification, environment, personal
            ...
            <Section bg="bone" size="default">
              <Heading
                ...
                description={
                  <>
                    <p>
                      MLS NEXT Academy is the next-tier roster within the same
                      MLS NEXT environment — same coaching standards, same
                      curriculum, same training environment as MLS NEXT, with
                      competition tuned for players still climbing toward the
                      top tier.
                    </p>
                    <p>
                      CVFC&rsquo;s MLS NEXT Academy program covers birth years
                      2007–2013 and gives players a clear, internal pathway to
                      the top MLS NEXT roster as they develop.
                    </p>
                  </>
                }
              />
              ...
              <Heading
                ...
                description={
                  <>
                    ...
                    <p>
                      CVFC&rsquo;s EA program covers birth years 2005–2013 and
                      is led by coaches with experience at the U.S. Youth
            ...
            <Section bg="bone" size="default">
              <Heading
                ...
                description={
                  <>
                    <p>
                      Chula Vista FC joined Elite Academy 2 (EA II) for the
                      2024–25 season, adding a second EA roster tier so more
                      players can compete in the elite environment. EA II pairs
                      with the main EA program to create internal competition,
                      push-up opportunities, and a more developmental structure
                ...
                description={
                  <>
                    <p>
                      ...
                      where developing teams build the foundation to step up to
                      EA or MLS NEXT when they&rsquo;re ready.
                    </p>
                    <p>
                ...
                description={
                  <>
                    <p>
                      ...
                      Premier League, where it has lifted the SWPL trophy. The
                      First Team has also advanced through the qualifying rounds
                      of the Lamar Hunt US Open Cup and reached NISA semifinals
                      — a real adult ceiling for senior players who want to stay
                      competitive after the youth pathway.
                    </p>
                    <p>
                      For players moving from U19 toward college, the First Team
                      is also a training environment they can learn from even
                      before they&rsquo;re old enough to play in it.
                    </p>
                  </>
                }
              />
                ...
                description={
                  <>
                    <p>
                      ...
                      <strong>Barça Academy Arizona</strong>, and have
                      represented the <strong>US National Team</strong> and the{" "}
                      <strong>Mexican National Team</strong>. That&rsquo;s the
                      ceiling — and it&rsquo;s real. The pathway works.
                    </p>
                    <p>
                      But most players who come through MLS NEXT, EA, or the
                      SoCal Flight system don&rsquo;t turn pro. That was never
                      the only point. They learn how to compete, how to lose and
                      come back, how to lead a teammate, and how to keep showing
                      up — skills that matter in college, in careers, and in
            ...
            <Callout
              ...
              body={
                <>
                  ...
                  birth year and a CVFC coach will be in touch with the next
                  step.
                </>
              }
              ctaSlot={
