...
export function GirlsCompetitivePathwayScreen() {
  return (
    <>
      <main>
        <PageHero
          ...
          body={
            <>
              <p>
                ...
                platform specifically designed to elevate girls&rsquo; soccer.
                CVFC was accepted into the DPL in April 2025 — a
              ...
              <p>
                ...
                beyond soccer skills to life lessons, community, and collegiate
                opportunities — and it pits CVFC players against the elite clubs
                of Southern California, who are among the nation&rsquo;s best.
              </p>
            </>
          }
          image={{
            ...
            description={
              <>
                <p>
                  ...
                  competitive pathway — a national-tier environment built for
                  the most committed female athletes, with full-year
                  development, top opponents from across the country, and direct
                  visibility for college recruiters and youth national team
                  scouts.
                </p>
                <p>
                  CVFC has applied for GA acceptance. Once placed, GA will sit
                  above GA Aspire, DPL, NPL, and the SoCal Flight system in the
                  girls competitive structure.
                </p>
              </>
            }
          />
        ...
        <Section bg="white" size="default">
          <Heading
            ...
            description={
              <>
                <p>
                  GA Aspire is the pre-Girls Academy environment that prepares
                  the next generation of GA-level players. It pairs the daily
                  standards of the top tier with a developmental focus, so
                  players who aren&rsquo;t yet on a GA roster can train,
                  compete, and grow toward it.
                </p>
                <p>
                  CVFC has applied for GA Aspire acceptance. Once placed, GA
                  Aspire will sit between GA and DPL in the girls competitive
                  structure.
                </p>
              </>
            }
        ...
        <Section bg="bone" size="default">
          <Heading
            ...
            description={
              <>
                <p>
                  The National Premier League (NPL) is one of the highest levels
                  of regional girls soccer in the U.S., with national playoff
                  visibility for top regional finishers. It&rsquo;s built for
                  players who want the rigor of a national-tier league while
                  staying rooted in regional competition.
                </p>
                <p>
                  CVFC NPL teams compete against the strongest clubs in Southern
                  California and have a real path to the NPL Showcase and
                  national playoff stages.
                </p>
              </>
            }
          />
        ...
        <Section bg="white" size="default">
          <Heading
            ...
            description={
              <>
                <p>
                  The SoCal Flight system tiers regional girls competition by
                  ability, so every team plays opponents at the level that
                  pushes them without overwhelming them. For CVFC, Flight is
                  where developing teams build the foundation to step up to NPL
                  or DPL when they&rsquo;re ready.
                </p>
                <p>
            ...
            description={
              <>
                <p>
                  ...
                  <strong>college recruiting visibility</strong> for the players
                  who want it, and <strong>life skills</strong> that carry every
                  player forward whether soccer stays in the picture or not. DPL
                  events, NPL playoffs, and Flight competition put players in
                  front of college coaches at every level. Daily training builds
                  the work ethic, leadership, and resilience that matter long
                  after.
                </p>
                <p>
                  Most CVFC girls won&rsquo;t play professionally —
                  there&rsquo;s no honest pathway in youth soccer that pretends
                  otherwise. But every player leaves better than she came:
                  stronger, sharper, more accountable, more capable of leading a
                  team.
                </p>
              </>
            }
        ...
        <Callout
          ...
          body={
            <>
              CVFC accepts evaluations year-round across DPL, NPL, and the SoCal
              Flight system, with applications submitted for GA and GA Aspire.
              Choose her birth year and a CVFC coach will be in touch with the
              next step.
            </>
          }
          ctaSlot={
