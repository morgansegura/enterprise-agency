    ...
    <>
      <main className={cn("landing-screen", className)}>
        ...
        <Callout
          ...
          body={
            <>
              Even if our tryouts have ended, players can still be evaluated on
              an individual basis. Chula Vista FC offers{" "}
        ...
        <Callout
          ...
          body={
            <>
              ...
              or ready to level up — we&rsquo;d love to meet your player. CVFC
              has been here since 1982, with a full pathway from Mini Maestros
              to MLS NEXT, Elite Academy, DPL, and NPL. Request an evaluation
              and a coach will follow up within 48 hours.
            </>
          }
          ctaSlot={
