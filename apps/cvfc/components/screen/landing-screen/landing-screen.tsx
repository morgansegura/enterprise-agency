...
export async function LandingScreen({ className }: { className?: string }) {
  // Hero is CMS-driven (falls back to the carousel's built-in slides). The rest
  // of the sections are static for now — they get CMS-wired one at a time.
  ...
  return (
    <main className={cn("landing-screen", className)}>
      ...
      <Callout
        ...
        body={
          <>
            ...
            <strong>individual evaluations</strong> &nbsp;for players who are
            new to the area or missed official tryout dates. Our comprehensive
            evaluation system is tailored to each player&rsquo;s level, style,
            and needs, with the goal of helping every athlete reach their full
      ...
      <MediaSplit
        ...
        body={
          <>
            Chula Vista FC is proud to offer elite opportunities for our female
            athletes, including <strong>NPL</strong> and <strong>DPL</strong>{" "}
            competition, with <strong>Girl&rsquo;s Academy (GA)</strong> and{" "}
            ...
            top-tier leagues and pathways ensure our players receive the highest
            level of training, competition, and exposure — helping them reach
      ...
      <MediaSplit
        ...
        body={
          <>
            Chula Vista FC offers one of the strongest competitive pathways for
            boys in Southern California, featuring <strong>MLS NEXT</strong> and{" "}
            <strong>MLS NEXT 2</strong>, along with{" "}
            <strong>Elite Academy (EA)</strong> and <strong>EA 2</strong>. We
            also compete in the <strong>SoCal League Flight system</strong>,
            providing the right level of competition for every stage of
            development. These platforms give our players elite training,
            top-level competition, and national exposure — preparing them to
      ...
      <StatBand
        ...
        description="The pathway delivers — measured by championships earned, professional contracts signed, and the families who've trusted Chula Vista FC since 1982."
        stats={[
      ...
      <Callout
        ...
        body={
          <>
            Whether you&rsquo;re new to the area, switching from another club,
            or ready to level up — we&rsquo;d love to meet your player. CVFC has
            been here since 1982, with a full pathway from Mini Maestros to MLS
            NEXT, Elite Academy, DPL, and NPL. Request an evaluation and a coach
