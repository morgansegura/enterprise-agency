...
export function WhoWeAreScreen() {
  return (
    <>
      <main>
        <PageHero
          ...
          body={
            <>
              <p>
                ...
                echelon of clubs in the South Bay area for over 40 years. As a
                member of the MLS Next League and Elite Academy League, we offer
                the highest standards and level of play at the youth level in
                San Diego under our core values of attitude, unity, respect, and
                passion.
              </p>
              <p>
                Since the club&rsquo;s beginnings, many changes have been made
                to foster and improve the development of players while
                maintaining a strong culture of local community identity. The
                goal for us is clear &mdash; to provide its members with value
                and for Chula Vista FC to continue functioning as one of the
                most professional clubs in the United States.
              </p>
            </>
          }
        />
        ...
        <MediaSplit
          ...
          body={
            <>
              <p>
                That&rsquo;s the work — and it has been since 1982. Chula Vista
                FC was founded in the South Bay and we&rsquo;re still rooted
                here, but the gate has always been open. Families come to us
                from across San Diego County, the Imperial Valley, the border
                region, and beyond. We measure players by what they&rsquo;re
                willing to do, not where they&rsquo;re coming from.
              </p>
              <p>
                Recent partnerships extend that reach: in 2025,{" "}
                <strong>San Diego FC</strong> partnered with Chula Vista FC to
                help grow the beautiful game across the region. In 2024, CVFC
                joined a campaign to improve soccer fields throughout Chula
                Vista — investing in the infrastructure the next generation of
                players will share.
              </p>
            </>
          }
          ...
          tags={["Boys & Girls", "Every Player", "San Diego FC Partnership"]}
        />
        ...
        <Section bg="white" size="default">
          <Heading
            ...
            description={
              <>
                <p>
                  Some of our coaches once wore the same crest they now teach
                  under. <strong>Fernando Mares</strong>, our Assistant Academy
                  Director, played for CVFC from 2000 to 2010 before returning
                  as a coach. <strong>Mathias Medel</strong>, our Director of
                  Mini Maestros, played his entire life with the club.{" "}
                  <strong>Javier Castorena</strong> wore the Chula Vista Pumas
                  shirt (now CVFC) from 1999 to 2008.
                </p>
                <p>
                  That continuity matters. Coaches who came up through the
                  pathway understand it. They mentor with the perspective of
                  having walked the same field as the players in front of them —
                  and they carry the club&rsquo;s identity forward.
                </p>
              </>
            }
          />
        ...
        <StatBand
          ...
          stats={[
            { id: "years", value: "40+", label: "Years Developing Players" },
          ...
          footnote={
            <>
              CVFC alumni have signed with <strong>MLS Colorado Rapids</strong>,{" "}
              <strong>FC Dallas</strong>, <strong>Austin FC</strong>,{" "}
              <strong>Atlas FC Academy</strong>, <strong>Club Tijuana</strong>,{" "}
              <strong>Club Rayados de Monterrey</strong>, and{" "}
              <strong>Barça Academy Arizona</strong> — and have represented the{" "}
              <strong>US National Team</strong> and the{" "}
              <strong>Mexican National Team</strong>. Competing through{" "}
              <strong>MLS NEXT</strong>, Elite Academy, NPL, DPL, the Southwest
              Premier League, and the Lamar Hunt US Open Cup.
            </>
          }
        />
        ...
        <Callout
          ...
          body={
            <>
              Whether your player is just getting started in Mini Maestros or
              ready to compete in MLS NEXT, the path begins with a conversation.
              Request an evaluation and a CVFC coach will be in touch.
            </>
          }
          ctaSlot={
