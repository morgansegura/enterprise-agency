...
export function GoalkeeperPathwayScreen() {
  return (
    <>
      <main>
        <PageHero
          ...
          body={
            <>
              <p>
                ...
                mental game all need their own time on the training ground — not
                just whatever&rsquo;s left over at the end of a team session.
              </p>
              <p>
                Our goalkeepers train alongside their pathway team (Foundations,
                Boys, Girls, MLS NEXT, DPL, etc.) but get dedicated GK sessions
                led by goalkeeping specialists. That&rsquo;s how a CVFC keeper
                develops the technical foundation, tactical awareness, and
                mental resilience to excel at club, college, and professional
                levels.
              </p>
            </>
          }
            ...
            description={
              <>
                <p>
                  ...
                  Alebrijes de Oaxaca; <strong>Carlos Arce</strong>, a former
                  Xolos U15 keeper who earned a full scholarship to Cal Poly San
                  Luis Obispo (coached by former US National Team head coach
                  Steve Sampson); and <strong>Victor Duran</strong>, who works
                  with our developing keepers across the pathway.
                </p>
                <p>
                  A few of our keepers will sign with college programs. Some may
                  push toward professional environments. Most won&rsquo;t — and
                  that&rsquo;s honest. What every CVFC keeper does take with
                  them is composure under pressure, decisiveness, and the kind
                  of mental toughness that pays off in every part of life after
                  the game.
                </p>
              </>
            }
        ...
        <Callout
          ...
          body={
            <>
              ...
              player&rsquo;s pathway and birth year, and our goalkeeping staff
              will be in touch.
            </>
          }
          ctaSlot={
