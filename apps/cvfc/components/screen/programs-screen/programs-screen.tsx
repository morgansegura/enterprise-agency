    ...
    <>
      <main className={className}>
        ...
        <MediaSplit
          ...
          body={
            <>
              ...
              level of competition for every stage of development.
            </>
          }
          image={{
        ...
        <MediaSplit
          ...
          body={
            <>
              Chula Vista FC offers elite opportunities for our female athletes,
              including <strong>NPL</strong> and <strong>DPL</strong>{" "}
              ...
              perfect level of competition to match their development.
            </>
          }
          image={{
