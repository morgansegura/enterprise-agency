...
/**
 * Wrap block output with generated CSS class when styles exist.
 * Visual styles come from the page-level <style id="page-styles"> tag
 * generated by generatePageCSS() — no inline styles needed.
 */
function withStyles(block: RootBlock, content: React.ReactNode, key?: string): React.ReactNode {
...
export function BlockRenderer({ blocks }: BlockRendererProps) {
  ...
  return blocks.map((block, i) =>
    withStyles(block, renderBlock(block), (block as { _key?: string })._key || String(i)),
  );
}
