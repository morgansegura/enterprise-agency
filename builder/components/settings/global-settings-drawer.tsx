  ...
  return (
    ...
    >
      ...
      <SettingsDrawerContent isLoading={isLoading}>
        {/* Auto-save indicator */}
        {isSaving && (
          <div className="fixed top-3 right-14 flex items-center gap-2 text-xs text-[var(--el-500)] bg-[var(--el-0)]/80 backdrop-blur-sm px-3 py-1.5 rounded-full border">
...
function CardSettingsPanel({
  ...
  const renderSelect = <K extends keyof CardSettings>(
    ...
    <div className="settings-field-compact">
      <Label className="text-xs text-[var(--el-500)]">{label}</Label>
      <Select
      ...
      <div className="space-y-8">
        ...
        {(formData.iconSvg || formData.logoSvg) && (
          <SettingsGridBlock title="Preview">
            <div className="col-span-2 flex flex-wrap items-center gap-8 p-4 rounded-lg border bg-[var(--el-100)]/30">
              {formData.iconSvg && (
                <div className="flex flex-col items-center gap-2">
                  ...
                  />
                  <span className="text-xs text-[var(--el-500)]">Icon</span>
                </div>
              )}
              {formData.logoSvg && (
                <div className="flex flex-col items-center gap-2">
                  <TenantLogo
                    ...
                    alt="Logo Preview"
                  />
                  <span className="text-xs text-[var(--el-500)]">Logo</span>
                </div>
              )}
            </div>
          </SettingsGridBlock>
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center py-12">
          <div className="text-sm text-[var(--el-500)]">Loading pages...</div>
        </div>
      </SettingsSection>
    );
  }
