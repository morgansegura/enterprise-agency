...
const buttonVariants = cva(
  "cursor-pointer inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md transition-colors duration-100 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-3.5 shrink-0 [&_svg]:shrink-0 [&_svg]:text-current outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]/50 focus-visible:ring-offset-1 font-medium text-[14px]",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: "h-6 rounded-md gap-1 px-2 has-[>svg]:px-1.5 text-[12px]",
