        ...
        >
          {selectedPage ? (
            <span className="flex items-center gap-2 truncate">
              <FileText className="h-4 w-4 shrink-0 text-(--el-500)" />
            ...
            <span className="text-(--el-500)">{noneLabel}</span>
          ) : (
            <span className="text-(--el-500)">{placeholder}</span>
          )}
                  ...
                  {publishedPages.map((page) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        <span className="text-xs text-(--el-500) shrink-0">
                          /{page.slug}
                        </span>
                        {page.isHomePage && (
